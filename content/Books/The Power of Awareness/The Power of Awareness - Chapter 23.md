...
It will be extremely helpful at this point to cite a number of specific examples of the successful application of this law. Actual case histories are given. In each of these, the problem is clearly defined and the way [imagination](/glossary#imagination) was used to attain the required [state](/glossary#state) of consciousness is fully described. In each of these instances, the author of this book was either personally concerned or was told the facts by the person involved.
