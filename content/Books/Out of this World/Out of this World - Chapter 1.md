...
chapter: Thinking Fourth-dimensionally
keywords:
  - Assumption
  - Meditation
  - Dreams
...
topics:
  ...
  - Man Can Alter His Future
  - Two Outlooks: Natural and Spiritual
  - Desire Is the Mainspring of Action
  - The Technique for Changing the Future
  - Premises Hardened Into Facts
  - Changing the Future Requires Changing the 4D Self
...
- What is seen before it occurs here must be predetermined from our 3D perspective.

### Man Can Alter His Future

- The author's aim is to show man can alter his future, but the altered future will still follow a deterministic sequence from the point of alteration.
- Man's future is flexible and determined more by his attitudes than his acts.
- Changing man's concept of himself automatically alters his future.

### Two Outlooks: Natural and Spiritual

- There are two outlooks - the natural focus on the senses, and the spiritual focus of controlled imagination.

- The spiritual view sees time's contents and the past/future as a present whole.

- We must cultivate the faculty of seeing the invisible by focusing beyond the senses.

## Desire Is the Mainspring of Action

- Desire impels all action and is awarenesss of something we lack.
- The spiritual man speaks through desire. Unhesitating obedience to desire assumes the wish fulfilled.

### The Technique for Changing the Future

1. Define your objective - know what you want.
2. Construct an event following desire's fulfillment.
3. Immobilize the body, induce a sleep-like state, and imagine performing the action now.
4. Always participate imagined action, don't just observe. Feel you are doing it now.
5. Restrict the action to a single act, don't let attention wander.
6. Repeat the act over and over until it feels real.
7. For conscious projection, continue until sleep onset.

### Premises Hardened Into Facts

- Feed the mind premises or assertions presumed true. If persisted in until felt real, they will harden into facts.

### Changing the Future Requires Changing the 4D Self

- To change the 3D world we must first change the 4D world.
- The 4D self has a larger outlook and constructs the means to realize the accepted end.
